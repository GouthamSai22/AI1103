...
\end{itemize}
From the given information, probability of man winning any round is $\frac{1}{6}$ and hence probability of him losing any round is $\frac{5}{6}$
\begin{align}
    P(X=0) &= \frac{1}{6} \\
    P(X=1) &= \frac{5}{6} \times \frac{1}{6} \\
    &= \frac{5}{36} \\
    P(X=2) &= \frac{5}{6} \times \frac{5}{6} \times \frac{1}{6} \\
     &= \frac{25}{216} \\
    P(X=3) &= \frac{5}{6} \times \frac{5}{6} \times \frac{5}{6} \\
     &= \frac{125}{216}
\end{align}
Since the man gets a rupee for every win and gives a rupee for every loss, the expected value of amount gained is
\begin{equation}
    Expected \ value = \sum_{i=0}^{3}P(X=i) \times (Amount \ gained \ when \ X=i)
\end{equation}
\begin{multline}
    Expected \ value &= \left( \frac{1}{6} \times 1 \right) + \left( \frac{5}{36} \times 0 \right) + \left(\frac{25}{216} \times (-1) \right)\\
