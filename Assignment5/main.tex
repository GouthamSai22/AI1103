...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Let \begin{align}
            ...
            &B_c(c)' \rightarrow \text{complement of } B_c(c) \\
            \implies &\pr{|X_n - c|>\epsilon} = \pr{X_ n\epsilon B_c(c)'}
        \end{align}
        ...
        \begin{align}
           \text{Since }\lim_{n \rightarrow \infty}X_n &= c \\
            \implies \limsup_{n \rightarrow \infty} \pr{X_n \epsilon B_c(c)'} &\leq  \pr{c \epsilon B_c(c)'} \\
            \pr{c \epsilon B_c(c)'} &= 0 \text{ (By defn)}
        \end{align}
        \item Thus,
        \begin{align}
            \lim_{n \rightarrow \infty}\pr{|X_n - c|>\epsilon} &= \lim_{n \rightarrow \infty}\pr{X_n \epsilon B_c(c)'} \\
            & \leq \limsup_{n \rightarrow \infty}\pr{X_n \epsilon B_c(c)'} \\
            &\leq \pr{c \epsilon B_c(c)'} \\
            &\leq 0 \\
            &= 0 
        \end{align}
...
\begin{enumerate}
    ...
    \begin{align}\nonumber
        p = 0 \implies X = 1
    \end{align}
    Since X is a constant, from \eqnref{2.0.15}, we can say that option 1 is true.
    \item Given,
      \begin{align}\nonumber
        p = 1 \implies X = 0
    \end{align}
    Since X is a constant, from \eqnref{2.0.15}, we can say that option 2 is true.
    \item Given,
      \begin{align}\nonumber
        0 < p < 1 \implies X \neq 0,1
    \end{align}
