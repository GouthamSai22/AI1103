...
For any given sequence of real-valued random variables $X_1,X_2,X_3, \dots ,X_n$, Let us look at some definitions
\begin{enumerate}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{align}
        \item By the Portmanteaus lemma(Part C),
        \begin{align}
           \text{Since }\lim_{n \rightarrow \infty}X_n &= c \\
            \implies \pr{X_n \epsilon B_c(c)^c} &\leq \limsup_{n \rightarrow \infty} \pr{c \epsilon B_c(c)^c} \\
            \pr{c \epsilon B_c(c)^c} &= 0 \text{ (By definition)}
        \end{align}
        \item Thus,
        \begin{align}
