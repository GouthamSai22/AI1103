...
\begin{lemma} Convergence in distribution implies convergence in probability if X is a constant.\end{lemma}
    ...
    \begin{itemize}
        ...
        \item Let \begin{align}
            &S \rightarrow \text{sphere centered at c, of radius } \epsilon \\
            &S^\prime \rightarrow \text{complement of } S \\
            \implies &\pr{|X_n - c|>\epsilon} = \pr{X_ n\in S^\prime}
        \end{align}
        ...
        \begin{align}
           \because \lim_{n \rightarrow \infty}X_n &= c \\
            \implies \limsup_{n \rightarrow \infty} \pr{X_n \in S^\prime} &\leq  \pr{c \in S^\prime} \\
            \pr{c \in S^\prime} &= 0 \text{ (By defn)}
        \end{align}
        \item Thus,
        \begin{align}
            \lim_{n \rightarrow \infty}\pr{|X_n - c|>\epsilon} &= \lim_{n \rightarrow \infty}\pr{X_n \in S^\prime} \\
            & \leq \limsup_{n \rightarrow \infty}\pr{X_n \in S^\prime} \\
            &\leq \pr{c \in S^\prime} \\
            &\leq 0 \\
            &= 0 
        \end{align}
